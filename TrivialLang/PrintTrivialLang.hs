...
-- | Pretty-printer for PrintTrivialLang.
--   Generated by the BNF converter.

module PrintTrivialLang where
...
instance Print LExp where
  prt i e = case e of
    Assn id intexp -> prPrec i 0 (concatD [prt 0 id, doc (showString ":="), prt 0 intexp])
    Prnt id -> prPrec i 0 (concatD [doc (showString "put"), prt 0 id])
